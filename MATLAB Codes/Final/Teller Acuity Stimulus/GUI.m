...
% Last Modified by GUIDE v2.5 29-Jan-2014 15:57:42
...
try
    ...
    %Number of reversal points to ignore
    numIgnore = 2;
    numReversals = 6;
    sumFrequency = 0;
	currentResponse = 'y';
    ...
    while tempReversals > 0
        ...
        %Phase calculations of the R, G, B channels of the animation. Phase
        %angles are assigned randomly to get random colors
        phase1 = 0.5 * rand() * pi;
        phase2 = 0.5 * rand() * pi;
        phase3 = 0.5 * rand() * pi;
        
        %Step size of the angular increment for each frame
        stepSize = pi / 500;
        ...
        while 1
            ...
            %Calculate colors of the animation depending on the phase and
            %the step increments
            %red   = 255 * abs(sin(i*stepSize + phase1));
            %blue  = 255 * abs(sin(i*stepSize + phase2));
            %green = 255 * abs(sin(i*stepSize + phase3));
            red = 255 * rand();
            blue = 255 * rand();
            green = 255 * rand();
            ...
            Screen('FillOval', window, [red blue green], [600 472 680 552]);
            Screen('FillOval', window, [green blue red], [560 492 600 532]);
            Screen('FillOval', window, [green blue red], [680 492 720 532]);
            Screen('FillOval', window, [green blue red], [620 432 660 472]);
            Screen('FillOval', window, [green blue red], [620 552 660 592]);
            Screen('Flip', window);
            ...
            %and make changes accordingly
                ...
                if strcmp(click, 'normal') || strcmp(click, 'alt')
                    if strcmp(click, 'normal') && direction == 0
                        response = 'y';
                    elseif strcmp(click, 'alt') && direction == 1
                        response = 'y';
                    else
                        response = 'n';
                    end
                    if ~strcmp(response, currentResponse)
    ...
    averageFrequency = sumFrequency / (numReversals * viewingAngle);
...
appdata.GUIDEOptions = struct(...
    ...
    'syscolorfig', 1, ...
    'blocking', 0, ...
    'lastSavedFile', 'C:\Documents and Settings\shrikant.LVPEI-14B3FF554\Desktop\Siddharth\GUI.m', ...
...
'String',blanks(0),...
'Style','edit',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)GUI('edit1_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','edit1');
...
'Units','characters',...
'BackgroundColor',[1 1 1],...
'Position',[9.6 38.1538461538463 30.4 2.07692307692308],...
'String',blanks(0),...
'Style','edit',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)GUI('edit2_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','edit2');
...
'Parent',h1,...
'Units','characters',...
'Position',[9.6 35.9230769230771 30.2 1.15384615384615],...
'String','Diagnosis',...
'Style','text',...
'Tag','text3',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'Units','characters',...
'BackgroundColor',[1 1 1],...
'Position',[9.4 33.0769230769231 30.4 2.07692307692308],...
'String',blanks(0),...
'Style','edit',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)GUI('edit3_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','edit3');
...
'Parent',h1,...
'Units','characters',...
'Position',[9.6 30.5384615384616 30.2 1.15384615384615],...
...
'Units','characters',...
'BackgroundColor',[1 1 1],...
'Position',[9.8 27.1538461538462 30.4 2.07692307692308],...
'String','38',...
'Style','edit',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)GUI('edit4_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','edit4');
...
'Parent',h1,...
'Units','characters',...
'Position',[9.8 24.4615384615385 30.2 1.15384615384615],...
...
'Units','characters',...
'BackgroundColor',[1 1 1],...
'Position',[9.8 21.3846153846154 30.4 2.07692307692308],...
'String','5',...
'Style','edit',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)GUI('edit5_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','edit5');
...
'Parent',h1,...
'Units','characters',...
'Position',[9.8 18.5384615384616 30.2 1.15384615384615],...
...
'Units','characters',...
'BackgroundColor',[1 1 1],...
'Position',[9.60000000000001 15.1538461538462 30.4 2.07692307692308],...
'String','3',...
'Style','edit',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)GUI('edit6_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','edit6');
...
'Parent',h1,...
'Units','characters',...
'Position',[9.60000000000001 12.6153846153846 30.2 1.15384615384615],...
'String','Orientation',...
'Style','text',...
'Tag','text7',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'Parent',h1,...
'Units','characters',...
'Callback',@(hObject,eventdata)GUI('pushbutton2_Callback',hObject,eventdata,guidata(hObject)),...
'Position',[5.8 2.84615384615385 38.2 4],...
'String','START TEST',...
'Tag','pushbutton2',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'Units','characters',...
'BackgroundColor',[1 1 1],...
'Callback',@(hObject,eventdata)GUI('popupmenu1_Callback',hObject,eventdata,guidata(hObject)),...
'Position',[9.8 9.69230769230771 30.2 1.92307692307692],...
'String',{  'Horizontal'; 'Vertical'; 'Random' },...
'Style','popupmenu',...
'Value',1,...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)GUI('popupmenu1_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','popupmenu1');
