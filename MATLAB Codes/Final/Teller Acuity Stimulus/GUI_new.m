...
% GUI_NEW M-file for GUI_new.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_LayoutFcn',  @GUI_new_LayoutFcn, ...
                   'gui_Callback',   []);
...
widthArrayX1 = -640 : 1919;
widthArrayX2 = -1919 : 640;
widthArrayY  = -540 : 539;
...
try
    ...
    while tempReversals > 0
        ...
        while 1
            ...
            Screen('FillOval', window, [red blue green], [1240 500 1320 580]);
            Screen('FillOval', window, [green blue red], [1200 520 1240 560]);
            Screen('FillOval', window, [green blue red], [1320 520 1360 560]);
            Screen('FillOval', window, [green blue red], [1260 460 1300 500]);
            Screen('FillOval', window, [green blue red], [1260 580 1300 620]);
            Screen('Flip', window);
...
function h1 = GUI_new_LayoutFcn(policy)
...
appdata.GUIDEOptions = struct(...
    ...
    'syscolorfig', 1, ...
    'blocking', 0, ...
    'lastSavedFile', 'C:\Documents and Settings\shrikant.LVPEI-14B3FF554\Desktop\Siddharth\GUI_new.m', ...
...
'String',blanks(0),...
'Style','edit',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)GUI_new('edit1_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','edit1');
...
'String',blanks(0),...
'Style','edit',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)GUI_new('edit2_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','edit2');
...
'String',blanks(0),...
'Style','edit',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)GUI_new('edit3_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','edit3');
...
'String','38',...
'Style','edit',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)GUI_new('edit4_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','edit4');
...
'String','5',...
'Style','edit',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)GUI_new('edit5_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','edit5');
...
'String','1',...
'Style','edit',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)GUI_new('edit6_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','edit6');
...
'Parent',h1,...
'Units','characters',...
'Callback',@(hObject,eventdata)GUI_new('pushbutton2_Callback',hObject,eventdata,guidata(hObject)),...
...
'Style','popupmenu',...
'Value',1,...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)GUI_new('popupmenu1_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','popupmenu1');
...
'Style','popupmenu',...
'Value',1,...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)GUI_new('popupmenu2_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','popupmenu2');
...
elseif local_isInvokeHGCallbak(gui_State, varargin{:})
    % GUI_NEW('CALLBACK',hObject,eventData,handles,...)
    gui_Create = false;
else
    % GUI_NEW(...)
